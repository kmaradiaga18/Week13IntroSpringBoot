...
public interface JeepSalesController {
  ...
  @Operation(
      ...
      description = "Returns a list of Jeeps given an optional moderl and/or trim",
      responses = {
          ...
          @ApiResponse(responseCode = "400", 
                       description = " he request parameters are invalid", 
  ...
  List<Jeep> fetchJeeps(
      ...
      @Length(max = Constants.TRIM__MAX_LENGTH)
      @Pattern(regexp = "[\\w\\s]*")
