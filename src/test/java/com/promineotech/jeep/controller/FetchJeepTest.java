...
class FetchJeepTest{
  ...
  void testThatAnErrorMessageIsReturnedWhenAInvalidValueIsSupplied(
  ...
  static Stream<Arguments> parametersForInvalidInput(){
    //@formatter:off
    return Stream.of(
        arguments("WRANGLER", "!E#$#@", "Trim contains non-alpha numeric chars"),
        arguments("WRANGLER", "C".repeat(Constants.TRIM__MAX_LENGTH + 1), "Trim length too long"),
